...
export const categories: CategoryType[] = [
  ...
  { id: "5", name: "Lashes", displayColor: "FFEFC2" },
  { id: "6", name: "Depilation", displayColor: "9F9CFF" },
  { id: "7", name: "Rest time", displayColor: "F5CF9F" },
  { id: "8", name: "Own time", displayColor: "F3F5A9" },
  { id: "9", name: "Holidays", displayColor: "D28A8C" },
];
